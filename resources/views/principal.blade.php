@extends('layout.template') <!-- está extendendo a view responsavel pelo o template base -->


@section('conteudo') <!-- indica que todo esse bloco de codigo dentro dessa sessão vai ser colocar la dentro de layout/template -->

@section('titulo', $titulo)

@include('layout.navbar')<!-- incluindo o menu aqui -->
